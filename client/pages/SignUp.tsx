                      ...
                      <div>
                        ...
                        <div className="relative mt-2">
                          ...
                          <Input
                            ...
                            className="bg-charcoal-800 border-charcoal-600 text-white placeholder:text-white/70 focus:border-gold-500 pl-10"
                            placeholder="First"
                            required
                          />
                        </div>
                    ...
                    <div>
                      ...
                      <div className="relative mt-2">
                        ...
                        <Input
                          ...
                          className="bg-charcoal-800 border-charcoal-600 text-white placeholder:text-white/70 focus:border-gold-500 pl-12"
